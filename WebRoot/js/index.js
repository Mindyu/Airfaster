function getCand(){
  ...
  DateRangePicker = (function() {
    ...
    DateRangePicker.prototype.showCustomDate = function() {
      ...
      document.getElementById("rTime").value = this.formatDate(this.endDate());
      document.getElementById("stTime").value = text;
...
function init() {
	getCand();
	var divD = document.getElementById("myDrp");
	//console.log(divD);
	divD.style.display = "none";
	
	var sT = document.getElementById("sTime");
	var index = sT.selectedIndex; 		// 选中索引
	var text = sT.options[index].text; // 选中文本
	if(text == "出发日期") {
		sT.style.color = "#A69999";
	}
